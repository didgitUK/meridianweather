...
const privacy = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        'Die Startseite kann zwei kurze Listen von Orten anzeigen:\n\n• In Ihrer Nähe — vorgeschlagene Orte in der Nähe Ihres Wohn- oder Heimatgebiets (kein privates Protokoll Ihrer Suchen).\n• Beliebte Suchen — häufig auf der Website gesuchte Orte aus gemeinsamen Prüfprotokollen. Bei einer frischen oder wenig genutzten Installation kann die Oberfläche kurz einige Demo-Städte anzeigen, bis echte Suchaktivität vorliegt.\n\nKeine der beiden Listen ist eine persönliche Historie Ihrer privaten Suchen.',
    },
    {
      id: 'changes',
      title: 'Änderungen',
  ...
  sections: [
    {
      ...
      title: 'Überblick',
      body:
        'Website Servers Ltd, handelnd als meridian, verwendet Cookies und ähnliche Technologien (einschließlich localStorage und sessionStorage) auf meridianweather.co.uk. Diese Cookie-Richtlinie erläutert, was wir speichern, warum und wie Sie dies gemäß den UK Privacy and Electronic Communications Regulations (PECR) und der UK GDPR steuern können.\n\nAngaben zum Verantwortlichen entsprechen unserer Datenschutzerklärung: Website Servers Ltd, Unternehmensnummer 17240780, eingetragener Sitz Orchard Cottage, Beck Orchard, Brampton, United Kingdom, CA8 1UR. Kontakt: privacy@meridianweather.co.uk.\n\nKurz gesagt: Die meisten Einstellungen bleiben auf Ihrem Gerät. Google kann Cookies setzen, nur wenn Sie Werbung oder Analysen erlauben und diese Produkte aktiviert sind.',
    },
    {
      id: 'what-we-use',
      title: 'Was wir verwenden (in einfachen Worten)',
      body:
        'Essenziell / immer aktiv: Merken, dass Sie das Cookie-Banner geschlossen haben; Ihre anonyme Client-ID für optionale E-Mail-Links; Theme- und Spracheinstellungen; und die Städte, die Sie anheften.\n\nFunktional (optional): Merken des aktuellen Wetters auf diesem Gerät zwischen Besuchen und präzise Standort-Hilfen, wenn Sie sie zulassen.\n\nWerbung (optional): Google AdSense, wenn konfiguriert. Die Messung, ob ein Werbeplatz gesehen wurde, erfordert ebenfalls diese Wahl.\n\nAnalysen (optional): unsere eigene einfache Seitennutzungsmessung und, wenn konfiguriert, Google Analytics. „Alle akzeptieren“ schaltet Analysen nicht ein — aktivieren Sie sie unter Präferenzen verwalten, wenn Sie sie möchten.\n\nDie Marketing-E-Mail-Einstellung ist reserviert und wird nicht für zusätzliche Marketing-Tracker über die E-Mails hinaus genutzt, für die Sie sich ausdrücklich anmelden.',
    },
    {
      id: 'local-storage',
      title: 'Auf diesem Gerät gespeicherte Namen',
      body:
        'Auf diesem Gerät können wir Schlüssel wie folgende speichern:\n\nmeridian:client-id — anonyme ID, die optionale E-Mail-Abonnements mit diesem Browser verknüpft.\n\nmeridian:saved-cities — Städte, die Sie anheften (bis zu zehn).\n\nmeridian:checked-cities — kürzliche Stadt-Suchen.\n\nmeridian:user-location — Heimat-/Regionsprofil und zugehörige Historie.\n\nmeridian:weather-cache — zwischengespeicherte Wetterdaten (nur geschrieben, wenn Funktional aktiv ist).\n\nmeridian:theme, meridian:temperature-unit, meridian:preferred-locale, meridian:accessibility, meridian:weather-refresh-mode, meridian:city-detail-accordion — Anzeigeeinstellungen.\n\nmeridian:consent — Ihre Kategorieauswahl.\n\nmeridian:cookie-consent — älteres Flag zur Banner-Bestätigung.\n\nmeridian:subscriptions — lokale Spiegelung der E-Mail-Präferenzen.\n\nmeridian:tier — reserviert (das Produkt ist derzeit kostenlos).\n\nsessionStorage meridian_analytics_sid — Sitzungs-ID, nur verwendet, wenn Analysen aktiv sind.\n\nDemo-Journalbeiträge können Kommentare nur auf Ihrem Gerät behalten.\n\nNur Mitarbeitende: ein HttpOnly-Cookie meridian_admin_session für die Admin-Konsole.',
    },
    {
      id: 'consent-categories',
      title: 'So treffen Sie Ihre Wahl',
      body:
        'essential — immer aktiv für grundlegende Dienstspeicherung.\n\nfunctional — auf diesem Gerät gespeichertes Wetter und präzise Standort-Hilfen, die Sie wählen.\n\nadvertising — Google AdSense, wenn konfiguriert; erforderlich auch für First-Party-Ad-Slot-View-Ereignisse.\n\nanalytics — First-Party-Nutzungsbeacon und Google Analytics, wenn konfiguriert.\n\nmarketing — reserviert.\n\nBanner-Optionen: Nur Essenzielles, Funktional akzeptieren, Alle akzeptieren oder Präferenzen verwalten. Öffnen Sie die Einstellungen erneut über die schwebende Einstellungssteuerung, wenn sie verfügbar ist (sie kann beim Scrollen ausgeblendet werden und kann bei reduzierter Bewegung verborgen sein). Alle akzeptieren = funktional + Werbung; schalten Sie Analysen separat ein, wenn Sie sie möchten.',
    },
    {
      id: 'third-party',
      title: 'Cookies von Drittanbietern',
      body:
        'Wenn die Werbe-Einwilligung aktiv ist und AdSense live ist, kann Google Cookies gemäß den Richtlinien von Google setzen.\n\nWenn die Analyse-Einwilligung aktiv ist und GA4 konfiguriert ist, kann Google Analytics eigene Cookies setzen.\n\nWir kontrollieren diese Drittanbieter-Cookies nicht vollständig. Prüfen Sie die Datenschutz- und Anzeigeneinstellungen von Google parallel zu dieser Richtlinie.',
    },
    {
      id: 'withdraw',
      title: 'Wie Sie ändern oder löschen',
      body:
        'Öffnen Sie Einstellungen → Cookies (wenn das Zahnrad verfügbar ist), oder löschen Sie Site-Daten für meridianweather.co.uk in Ihrem Browser.\n\nDas Deaktivieren von Werbung stoppt unser AdSense-Skript bei späteren Besuchen. Das Deaktivieren von Analysen stoppt unseren Nutzungsbeacon und den GA-Loader, wenn konfiguriert.\n\nFragen: privacy@meridianweather.co.uk.',
    },
  ],
};
